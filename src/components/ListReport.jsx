...
export default function ListReport() {
  ...
  return (
    <div className="p-3">
      <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 md:grid-cols-3  lg:grid-cols-4 text-left">
        {reportData.map((report) => (
          <div key={report._id} className=" bg-white p-0 rounded-lg shadow-md">
            <div className="relative h-48">
              ...
              />
              <div className="absolute bottom-0 right-0 bg-green-500 text-white text-xs p-1  rounded-l-lg">
                {report.status}
              </div>
            </div>
