        ...
        <div className='mx-auto px-4 pt-5 md:pt-20'>
          <div className='mb-20 flex flex-col justify-center gap-8 md:flex-row md:gap-32'>
            ...
            <div className='flex flex-col gap-2'>
              ...
              <a href='#alurAduan'>
                <div className='text-center text-lg text-white transition duration-200 hover:text-blue-600 md:text-start'>Alur Aduan</div>
              </a>
              <a href='#kategori'>
                <div className='text-center text-lg text-white transition duration-200 hover:text-blue-600 md:text-start'>Kategori</div>
              </a>
              <a href='#laporan'>
                <div className='text-center text-lg text-white transition duration-200 hover:text-blue-600 md:text-start'>Laporan</div>
              </a>
              <Link to='/login' className='text-center text-lg text-white transition duration-200 hover:text-blue-600 md:text-start'>
                Login
              </Link>
            </div>
          </div>
