    ...
    <div className='m-2 my-8 md:px-4'>
      <div className='animate__fadeIn animate__animated animate__delay-0.5s box-border rounded-3xl bg-white px-4 py-8 drop-shadow md:p-12 capitalize'>
        <div className='flex items-center justify-center mb-2 md:mb-8 mx-auto'>
          <h2 className='md:text-4xl ml-4 text-center text-lg font-semibold text-primary-600'>Tambah Unit Kerja</h2>
        </div>
        <div className='flex flex-col mt-4'>
          <label className='block mb-2 text-xs md:text-base text-gray-900 font-semibold'>Nama Unit Kerja</label>
          <input
            type='text'
            name='title'
        ...
        <div className='col-span-1'>
          <div className=''>
            <label className='block my-2.5 text-xs md:text-base text-gray-900 font-semibold'>Bukti Laporan:</label>
