  ...
  return (
    <div>
      <div className='flex items-center'>
        ...
        <h2 className='md:text-2xl text-xl  font-semibold text-slate-900'>{title}</h2>
      </div>
      ...
      <ListReport searchTerm={searchTerm} currentPage={currentPage} reportsPerPage={reportsPerPage} url={url} />
      {/* pagination */}
