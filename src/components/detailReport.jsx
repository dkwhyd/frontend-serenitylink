          ...
          <div className='flex flex-col mb-4'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
              <div className='col-span-1'>
                ...
                <div className='flex flex-col'>
                  <label className='font-semibold text-gray-900'>Lokasi Kejadian:</label>
            ...
            {report.unitWorks ? (
              <div className='flex flex-col'>
                <label className='font-semibold text-gray-900'>Unit Kerja:</label>
                <div>
                  <img className='w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 rounded-full group-hover:outline ' src={`http://localhost:5500/public/image/${report.unitWorks.image}`} alt={report.unitWorks.name} />
            ...
            {report.officerReport ? (
              <div>
                <label className='font-semibold text-gray-900'>Laporan Petugas:</label>
            ...
            {!report.officerReport && auth.user.role === 'officer' ? (
              <div className=''>
                Buat Laporan
                <div className='flex flex-col'>
                  <label className='block mb-2 text-xs md:text-base text-gray-900 font-semibold'>Pesan:</label>
                  <input
                    type='text'
                    name='title'
                ...
                <div className='col-span-1'>
                  ...
                  <div className='text-center mt:4 md:mt-8 w-full'>
                    <button className='bg-blue-600 mt-4 float-right py-2 px-6 rounded-lg focus:outline-none transition-all ease-out text-white hover:bg-blue-700 focus:bg-blue-900' onClick={(e) => sendOfficeReport(e)}>
                      Kirim
                    </button>
                  </div>
                </div>
            ...
            {!report.unitWorks && auth.user.role === 'admin' ? (
              <div className='flex flex-col'>
                <label className='font-semibold text-gray-900'>Kirim Laporan ke Unit Kerja</label>
                <select id='selectOption' onChange={handleSelectChange} value={selectedOption || ''}>
                ...
                <button className='bg-blue-600 mt-4 float-right py-2 px-6 rounded-lg focus:outline-none transition-all ease-out text-white hover:bg-blue-700 focus:bg-blue-900' onClick={() => assignReportToUnitwork(report._id)}>
                  Kirim
                </button>
              </div>
            ) : null}
